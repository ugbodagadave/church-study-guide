...
class TestContentGenerator:
    ...
    def test_generate_content_gemini_success(self, mock_getenv, mock_get_client, mock_bible_fetcher):
        # Setup Gemini mock
    ...
    @patch('src.generation.content_generator.get_llm_client')
    @patch('src.generation.content_generator.os.getenv')
    def test_validate_schema_failure(self, mock_getenv, mock_get_client):
        mock_client = MagicMock()
        ...
        # Mock env var
        mock_getenv.return_value = 'gemini-model'
    ...
    @patch('src.generation.content_generator.get_llm_client')
    @patch('src.generation.content_generator.os.getenv')
    def test_json_parse_failure(self, mock_getenv, mock_get_client):
        mock_client = MagicMock()
        mock_response = MagicMock()
