...
2. Each day must include:
   ...
   - Scripture Reference: A SINGLE relevant Bible verse reference (e.g., "John 3:16") supporting the day's theme. Do NOT provide multiple references (e.g. avoid "John 3:16; Rom 8:1").
    - Reflection: A ~250 word devotional reflection based on the sermon's core points.
      - TONE: Write in a DIRECT, personal, and encouraging voice. Keep the language SIMPLE and easy to understand. Do NOT use phrases like "The sermon says", "The speaker mentions", or "The text opens with". Instead, say "You are called to...", "God's word declares...", "Remember that...".
 ...
 5. Select a "Memory Verse" for the week. Provide the reference only (e.g. "Romans 8:28").
